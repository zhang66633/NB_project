<template>
  <div class="flex h-screen bg-background">
    <!-- Left: Files sidebar -->
    <div class="w-64 border-r bg-background flex flex-col">
      <div class="flex items-center gap-2 h-14 border-b px-4">
        <button
        ...
        <span class="text-sm font-semibold truncate">任务文件</span>
      </div>
      ...
      <header class="flex h-14 items-center justify-between border-b px-4 gap-3">
        <div class="flex items-center gap-3">
          ...
          <span
            ...
            :class="task.mode === 'execute' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700'"
          >
    ...
    <!-- Right: Notebook -->
    <div class="w-80 border-l bg-background flex flex-col overflow-hidden">
      <div class="border-b px-4 py-2 bg-muted/30 flex items-center justify-between">
